...
(function (global, factory) {
                ...
                (element2) =>
                    new Promise((resolve, reject) => {
                        ...
                        const timer = setTimeout(
                            () => trigger(element2, clsTransitionEnd),
                            duration,
                        );
                        once(
                            element2,
            ...
            toNodes(element).map(
                (element2) =>
                    new Promise((resolve, reject) => {
                        ...
                        const timer = setTimeout(
                            () => trigger(element2, clsAnimationEnd),
                            duration,
                        );
                        once(
                            element2,
                        ...
                        if (startsWith(animation, animationPrefix)) {
                            origin &&
                                addClass(
                                    element2,
                                    `uk-transform-origin-${origin}`,
                                );
                            out &&
                                addClass(element2, `${animationPrefix}reverse`);
                        }
                    }),
            ),
        );
    ...
    var SliderDrag = {
        ...
        methods: {
            ...
            _getDistance(prev, next) {
                return (
                    this._getTransitioner(
                        prev,
                        prev !== next && next,
                    ).getDistance() || this.slides[prev].offsetWidth
                );
            },
        },
    };
    ...
    function toMedia(value, element) {
        if (isString(value)) {
            if (startsWith(value, "@")) {
                value = toFloat(
                    css(element, `--uk-breakpoint-${value.substr(1)}`),
                );
            } else if (isNaN(value)) {
                return value;
            }
                ...
                for (let i = 0; i < this.length; i++) {
                    ...
                    if (this.center) {
                        if (
                            ...
                            left +
                                slideWidth +
                                dimensions$1(getIndex(+i + 1, this.slides))
                                    .width /
                                    2 >
                                width / 2
                        ) {
    ...
    const supportsAspectRatio =
        inBrowser && CSS.supports("aspect-ratio", "1/1");
    var slideshow = {
                ...
                for (const [i, [axis, prop, start, end]] of dirs) {
                    if (
                        ...
                        const positionOffset = Math.abs(
                            this.getPositionOffset(this.$el),
                        );
    ...
    function getPositionedElements(el) {
        ...
        apply(
            el,
            (el2) => css(el2, "position") !== "static" && result.push(el2),
        );
        return result;
    }
                ...
                handler({ target }) {
                    ...
                    const adjustHeight = () => {
                        ...
                        css(
                            this.dropbar,
                            "top",
                            this.dropbar.offsetTop -
                                (dropbarOffset.top - minTop) -
                                this.dropbarOffset,
                        );
                        this.transitionTo(
                            maxBottom -
    ...
    var navbar = {
        ...
        methods: {
            ...
            registerColorListener() {
                    ...
                    !$$(".uk-drop", this.dropContainer)
                        ...
                        .some(
                            (drop) =>
                                drop.isToggled() &&
                                (drop.inset ||
                                    this.getTransparentMode(drop.$el) ===
                                        "behind"),
                        );
                ...
                this._colorListener = listenForPositionChange(
                    this.navbarContainer,
                    () => {
                        const { left, top, height } = offset(
                            this.navbarContainer,
                        );
                        const startPoint = {
                            x: left,
                        ...
                        const target = $$(this.selTransparentTarget).find(
                            (target2) =>
                                pointInRect(startPoint, offset(target2)),
                        );
    ...
    function listenForPositionChange(el, handler) {
        ...
        const scrollEl =
            parent2 === document.documentElement ? document : parent2;
                ...
                read() {
                    ...
                    if (scrollTop === max) {
                        ...
                        for (let i = 0; i < targets.length; i++) {
                            ...
                            const offsetBy =
                                this.offset +
                                (fixedEl ? offset(fixedEl).height : 0);
                            if (
    ...
    var toggle = {
        ...
        events: [
            ...
            },
            {
                name: "click",
                filter() {
                    return ["click", "hover"].some((mode) =>
                        includes(this.mode, mode),
                    );
                },
                handler(e) {
                    let link;
